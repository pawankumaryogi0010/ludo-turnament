 ...
 * Version: 10.0.1 - ALL CRITICAL FIXES APPLIED
 * ======================================================
 */
    ...
    <div id="app-wrapper">
            ...
            <div class="banner-track" id="bannerTrack">
                ...
                <div class="banner-slide">
                    <div class="banner-card banner-1">
                        ...
                        <div class="banner-image">
                            <img src="<?php echo $basePath; ?>/assets/images/banner-welcome.svg" alt="Welcome Bonus" onerror="this.style.display='none'" style="width:100px;height:100px;">
                        </div>
                    </div>
                </div>
                ...
                <div class="banner-slide">
                    <div class="banner-card banner-2">
                        ...
                        <div class="banner-image">
                            <img src="<?php echo $basePath; ?>/assets/images/banner-refer.svg" alt="Refer & Earn" onerror="this.style.display='none'" style="width:100px;height:100px;">
                        </div>
                    </div>
                </div>
                ...
                <div class="banner-slide">
                    <div class="banner-card banner-3">
                        ...
                        <div class="banner-image">
                            <img src="<?php echo $basePath; ?>/assets/images/banner-tournament.svg" alt="Tournament" onerror="this.style.display='none'" style="width:100px;height:100px;">
                        </div>
                    </div>
                </div>
                ...
                <div class="banner-slide">
                    <div class="banner-card banner-4">
                        ...
                        <div class="banner-image">
                            <img src="<?php echo $basePath; ?>/assets/images/banner-secure.svg" alt="Secure" onerror="this.style.display='none'" style="width:100px;height:100px;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="main-content" id="appMain">
            ...
            <section id="page-dashboard" class="page active">
                ...
                <div class="section-container">
                    <div class="section-header"><h3 class="section-title">🎟️ Tournament Tickets</h3><button class="btn-view-all" onclick="window.app.navigateTo('tournaments')">View All →</button></div>
                    <div class="tournament-grid-zupee" id="tournamentGrid">
                        <div class="tournament-card-zupee" onclick="window.app.handleJoinTournament(10, 1)">
                            ...
                            <div class="tcz-body"><div class="tcz-prize-row"><span class="tcz-prize-label">Prize Pool</span><span class="tcz-prize-amount">₹17</span></div><div class="tcz-progress"><div class="tcz-progress-bar" style="width:50%"></div></div><div class="tcz-info-row"><span>🎯 4 Players</span><span>⏱️ 15 min</span></div></div>
                        </div>
                        <div class="tournament-card-zupee featured-card" onclick="window.app.handleJoinTournament(20, 2)">
                            ...
                            <div class="tcz-body"><div class="tcz-prize-row"><span class="tcz-prize-label">Prize Pool</span><span class="tcz-prize-amount">₹34</span></div><div class="tcz-progress"><div class="tcz-progress-bar" style="width:75%"></div></div><div class="tcz-info-row"><span>🎯 4 Players</span><span>⏱️ 15 min</span></div></div>
                        </div>
                        <div class="tournament-card-zupee" onclick="window.app.handleJoinTournament(50, 3)">
                            ...
                            <div class="tcz-body"><div class="tcz-prize-row"><span class="tcz-prize-label">Prize Pool</span><span class="tcz-prize-amount">₹85</span></div><div class="tcz-progress"><div class="tcz-progress-bar" style="width:25%"></div></div><div class="tcz-info-row"><span>🎯 4 Players</span><span>⏱️ 15 min</span></div></div>
                        </div>
                        <div class="tournament-card-zupee premium-card" onclick="window.app.handleJoinTournament(100, 4)">
                            ...
                            <div class="tcz-body"><div class="tcz-prize-row"><span class="tcz-prize-label">Prize Pool</span><span class="tcz-prize-amount">₹170</span></div><div class="tcz-progress"><div class="tcz-progress-bar" style="width:25%"></div></div><div class="tcz-info-row"><span>🎯 4 Players</span><span>⏱️ 15 min</span></div></div>
                        </div>
                    </div>
                </div>
            </section>

            <!-- OTHER PAGES (wallet, refer, history, profile) - Same as before -->
            <section id="page-wallet" class="page"><div class="wallet-page-container"><div class="wallet-balance-card"><span class="wbc-label">Available Balance</span><span class="wbc-amount" id="walletLarge">₹0.00</span><div class="wbc-actions"><button class="btn-add-cash" id="addMoneyBtn">+ Add Cash</button><button class="btn-withdraw" id="withdrawBtn">Withdraw</button></div></div></div></section>
            <section id="page-refer" class="page"><div class="refer-container"><div class="refer-hero-card"><span class="refer-icon">🎁</span><h2>Refer & Earn ₹50</h2><p>Share your code with friends</p><div class="refer-code-box"><span id="referCodeText">REF123456</span><button class="btn-copy" id="copyCodeBtn">Copy</button></div></div></div></section>
            <section id="page-history" class="page"><div class="history-container"><div class="history-filters-zupee"><button class="filter-btn-zupee active" data-filter="all">All</button><button class="filter-btn-zupee" data-filter="won">Won</button><button class="filter-btn-zupee" data-filter="lost">Lost</button></div><div class="history-list-zupee" id="historyList"><div class="history-empty">No matches yet</div></div></div></section>
            <section id="page-profile" class="page"><div class="profile-container"><div class="profile-header-card"><div class="profile-avatar-zupee">G</div><h3 id="profileName">Guest User</h3></div><div class="profile-menu-zupee"><button class="pm-item" id="loginBtn">🔑 Login</button><button class="pm-item" id="registerBtn">📝 Register</button><button class="pm-item" id="logoutBtn" style="display:none">🚪 Logout</button></div></div></section>
        ...
        <div class="modal-overlay-zupee" id="authModal">
            <div class="modal-card-zupee">
                <div class="modal-header-zupee"><h2 id="authModalTitle">Welcome Back!</h2><button class="modal-close-zupee" id="authModalClose">✕</button></div>
    ...
    <script>
        class ZupeeApp {
            ...
            startBannerCarousel() {
                ...
                const totalSlides = 4;
                const updateBanner = (index) => { track.style.transform = `translateX(-${index * 100}%)`; dots.forEach(d => d.classList.remove('active')); if(dots[index]) dots[index].classList.add('active'); };
                this.bannerInterval = setInterval(() => { this.bannerIndex = (this.bannerIndex + 1) % totalSlides; updateBanner(this.bannerIndex); }, 4000);
                dots.forEach(dot => { dot.addEventListener('click', () => { this.bannerIndex = parseInt(dot.dataset.index); updateBanner(this.bannerIndex); clearInterval(this.bannerInterval); this.bannerInterval = setInterval(() => { this.bannerIndex = (this.bannerIndex + 1) % totalSlides; updateBanner(this.bannerIndex); }, 4000); }); });
                let touchStartX = 0;
                document.getElementById('bannerCarousel').addEventListener('touchstart', (e) => { touchStartX = e.changedTouches[0].screenX; });
                document.getElementById('bannerCarousel').addEventListener('touchend', (e) => { const diff = touchStartX - e.changedTouches[0].screenX; if (diff > 50) this.bannerIndex = (this.bannerIndex + 1) % totalSlides; else if (diff < -50) this.bannerIndex = (this.bannerIndex - 1 + totalSlides) % totalSlides; updateBanner(this.bannerIndex); });
            }

            bindNavigation() {
                document.querySelectorAll('.bn-item').forEach(item => { item.addEventListener('click', () => this.navigateTo(item.dataset.page)); });
            ...
            bindAuthEvents() {
                ...
                document.getElementById('copyCodeBtn')?.addEventListener('click', () => { const code = document.getElementById('referCodeText')?.textContent || 'REF123456'; navigator.clipboard?.writeText(code).then(() => this.showToast('✅ Copied!', 'success')); });
            }
            ...
            async handleLogin() {
                ...
                if (result.success) { this.isLoggedIn = true; this.userData = result.data.user; this.updateUI(); this.closeAuthModal(); this.showToast('✅ Login successful!', 'success'); }
                else this.showToast('❌ ' + (result.message || 'Login failed'), 'error');
            }

            async handleRegister() {
                if (!document.getElementById('regTerms').checked) { this.showToast('Accept Terms', 'error'); return; }
                const data = { username: document.getElementById('regUsername').value.trim(), mobile: document.getElementById('regMobile').value.trim(), email: document.getElementById('regEmail').value.trim(), password: document.getElementById('regPassword').value, referral_code: document.getElementById('regReferral').value.trim() };
                ...
                if (result.success) { this.isLoggedIn = true; this.userData = result.data.user; this.updateUI(); this.closeAuthModal(); this.showToast('✅ Registered!', 'success'); }
            ...
            // FIXED: These methods are exposed globally via constructor binding below
            ...
            async handleJoinTournament(entryFee, tournamentId) {
                ...
                try {
                    const response = await fetch(`${this.basePath}/api/match.php?action=join`, { method: 'POST', headers: { 'Content-Type': 'application/json', 'X-CSRF-Token': this.csrfToken }, credentials: 'include', body: JSON.stringify({ entry_fee: entryFee, tournament_id: tournamentId, csrf_token: this.csrfToken }) });
