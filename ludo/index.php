...
/**
 * ======================================================
 * INDEX.PHP - COMPLETE SPA (FULL FIXED)
 * Ludo Tournament Platform - All Features Connected
 * Version: 15.0.0 - LOGIN FIX + CSRF FIX + LAYOUT FIX
 * ======================================================
 */
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body { font-family: 'Poppins', sans-serif; background: #700202; color: #FFFFFF; }
        
        #app-wrapper {
            width: 100%; max-width: 480px; height: 100vh; height: 100dvh;
            margin: 0 auto; position: relative; overflow: hidden;
            display: flex; flex-direction: column; background: #700202;
        }
        ...
        .zupee-header {
            ...
            padding: 12px 16px; background: #a10303;
        ...
        .btn-wallet-badge { display: flex; align-items: center; gap: 6px; padding: 8px 14px; background: rgba(255,255,255,0.2); color: white; border: none; border-radius: 9999px; font-weight: 600; font-size: 13px; cursor: pointer; font-family: inherit; transition: background 0.3s ease; }
        .btn-wallet-badge:hover { background: rgba(255,255,255,0.3); transform: scale(1.03); }
        .btn-login-sm { padding: 8px 16px; background: #00A859; color: white; border: none; border-radius: 9999px; font-weight: 600; font-size: 13px; cursor: pointer; font-family: inherit; }
        .btn-login-sm:hover { transform: scale(1.03); }
        
        .main-content { flex: 1; overflow-y: auto; overflow-x: hidden; padding: 0 16px 0 16px; -webkit-overflow-scrolling: touch; }
        ...
        .bottom-nav-zupee {
            ...
            padding: 8px 4px 12px; background: #a10303;
            border-top: 1px solid rgba(255,255,255,0.1);
            flex-shrink: 0; z-index: 100; min-height: 64px;
        }
        .bn-item { display: flex; flex-direction: column; align-items: center; gap: 2px; padding: 6px 12px; border: none; background: none; color: rgba(255,255,255,0.8); font-size: 10px; font-weight: 500; cursor: pointer; font-family: inherit; }
        .bn-item .bn-icon { font-size: 22px; }
        .bn-item.active { color: #FFD700; font-weight: 700; }
        .bn-center { position: relative; margin-top: -20px; }
        .bn-center-btn { width: 52px; height: 52px; border-radius: 50%; background: #FFD700; display: flex; align-items: center; justify-content: center; font-size: 24px; box-shadow: 0 4px 16px rgba(255,215,0,0.4); }
        
        .back-btn-header { display: flex; align-items: center; gap: 10px; padding: 14px 16px; background: #a10303; color: white; border: none; font-size: 15px; font-weight: 600; cursor: pointer; font-family: inherit; width: 100%; border-bottom: 1px solid rgba(255,255,255,0.1); transition: background 0.2s; }
        ...
        .banner-btn { padding: 8px 20px; background: white; color: #333; border: none; border-radius: 9999px; font-weight: 700; font-size: 13px; cursor: pointer; font-family: inherit; }
        ...
        .tournament-card-zupee { background: #a10303; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.2); cursor: pointer; transition: all 0.3s ease; border: 2px solid transparent; }
        ...
        .tcz-header { display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; background: rgba(255,255,255,0.05); }
        ...
        .htp-step { flex: 1; text-align: center; padding: 16px 8px; background: #a10303; border-radius: 12px; box-shadow: 0 4px 16px rgba(0,0,0,0.2); }
        .htp-number { width: 36px; height: 36px; border-radius: 50%; background: #FFD700; color: #333; display: flex; align-items: center; justify-content: center; font-weight: 700; margin: 0 auto 8px; }
        ...
        .wallet-balance-card { background: #a10303; border-radius: 16px; padding: 24px; text-align: center; box-shadow: 0 4px 16px rgba(0,0,0,0.2); }
        ...
        .btn-add-cash, .btn-withdraw { flex: 1; padding: 12px; border: none; border-radius: 12px; font-weight: 700; font-size: 14px; cursor: pointer; font-family: inherit; }
        ...
        .refer-hero-card { background: #a10303; border-radius: 16px; padding: 32px; text-align: center; box-shadow: 0 4px 16px rgba(0,0,0,0.2); }
        ...
        .btn-copy { padding: 10px 24px; background: #FFD700; color: #333; border: none; border-radius: 12px; font-weight: 700; cursor: pointer; font-family: inherit; }
        
        .profile-header-card { background: #a10303; border-radius: 16px; padding: 24px; text-align: center; box-shadow: 0 4px 16px rgba(0,0,0,0.2); margin-bottom: 16px; }
        .profile-avatar-zupee { width: 80px; height: 80px; border-radius: 50%; background: #FFD700; color: #333; display: flex; align-items: center; justify-content: center; font-size: 36px; font-weight: 800; margin: 0 auto 12px; }
        .profile-menu-zupee { margin-top: 16px; }
        .pm-item { width: 100%; padding: 14px; background: #a10303; border: none; border-radius: 12px; font-size: 14px; font-weight: 600; color: #FFFFFF; text-align: left; cursor: pointer; font-family: inherit; box-shadow: 0 2px 8px rgba(0,0,0,0.2); margin-bottom: 8px; }
        .pm-item:hover { background: #0ABD75; }
        
        .history-filters-zupee { display: flex; gap: 8px; margin-bottom: 16px; }
        .filter-btn-zupee { flex: 1; padding: 10px; border: 2px solid rgba(255,255,255,0.2); border-radius: 9999px; background: transparent; color: rgba(255,255,255,0.8); font-weight: 600; font-size: 13px; cursor: pointer; font-family: inherit; }
        ...
        .modal-card-zupee { background: #a10303; border-radius: 16px; max-width: 400px; width: 100%; max-height: 90vh; overflow-y: auto; box-shadow: 0 20px 60px rgba(0,0,0,0.5); animation: modalSlideUp 0.3s ease; }
        ...
        .form-group-zupee input[type="text"], .form-group-zupee input[type="tel"], .form-group-zupee input[type="password"], .form-group-zupee input[type="email"] { width: 100%; padding: 12px 14px; border: 2px solid rgba(255,255,255,0.2); border-radius: 12px; font-size: 14px; font-family: inherit; background: rgba(255,255,255,0.1); color: white; outline: none; }
        ...
        .btn-auth-submit { width: 100%; padding: 14px; background: #FFD700; color: #333; border: none; border-radius: 12px; font-weight: 700; font-size: 16px; cursor: pointer; font-family: inherit; margin-top: 8px; }
        ...
        .popup-card { background: #1A1A2E; border-radius: 16px; padding: 0; width: 90%; max-width: 380px; position: relative; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.5); animation: popupIn 0.3s ease; }
        ...
        .popup-close-btn { position: absolute; top: 10px; right: 10px; width: 32px; height: 32px; border-radius: 50%; background: rgba(0,0,0,0.6); color: white; border: 2px solid rgba(255,255,255,0.5); font-size: 18px; cursor: pointer; display: flex; align-items: center; justify-content: center; z-index: 10; transition: all 0.2s; }
        ...
        .popup-dot { width: 8px; height: 8px; border-radius: 50%; background: rgba(255,255,255,0.3); cursor: pointer; transition: all 0.3s; }
        .popup-dot.active { background: #FFD700; width: 24px; border-radius: 4px; }
        
        .kyc-form input, .bank-form input, .kyc-form select { width: 100%; padding: 12px 14px; border: 2px solid rgba(255,255,255,0.2); border-radius: 8px; background: rgba(255,255,255,0.1); color: white; font-size: 14px; font-family: inherit; margin-bottom: 10px; outline: none; transition: border-color 0.2s; }
        .kyc-form input:focus, .bank-form input:focus, .kyc-form select:focus { border-color: #FFD700; }
        .kyc-form select option { background: #1A1A2E; color: white; }
        .lang-select-profile { width: 100%; padding: 12px 14px; border-radius: 8px; background: rgba(255,255,255,0.1); color: white; border: 2px solid rgba(255,255,255,0.2); font-family: inherit; font-size: 14px; cursor: pointer; margin-top: 8px; outline: none; }
        .lang-select-profile:focus { border-color: #FFD700; }
        .lang-select-profile option { background: #1A1A2E; color: white; }
        
        .toast-zupee { position: fixed; bottom: 100px; left: 50%; transform: translateX(-50%) translateY(20px); padding: 12px 24px; border-radius: 30px; font-weight: 600; font-size: 14px; z-index: 4000; opacity: 0; transition: all 0.3s ease; pointer-events: none; white-space: nowrap; box-shadow: 0 4px 16px rgba(0,0,0,0.2); }
...
<body>
        ...
        <main class="main-content" id="appMain">
            ...
            <section id="page-dashboard" class="page active">
                <div class="banner-carousel" id="bannerCarousel">
                    <div class="banner-track" id="bannerTrack">
                        <div class="banner-slide"><div class="banner-card banner-1"><div class="banner-content"><h2 class="banner-title">🎉 ₹100 Welcome Bonus</h2><p class="banner-desc">Sign up & get instant bonus!</p><button class="banner-btn" onclick="window.app.openAuthModal('register')">Claim Now →</button></div></div></div>
                        <div class="banner-slide"><div class="banner-card banner-2"><div class="banner-content"><h2 class="banner-title">👥 Refer & Earn ₹50</h2><p class="banner-desc">Per friend who joins & plays!</p><button class="banner-btn" onclick="window.app.navigateTo('refer')">Invite Friends →</button></div></div></div>
                        <div class="banner-slide"><div class="banner-card banner-3"><div class="banner-content"><h2 class="banner-title">🏆 Mega Tournament</h2><p class="banner-desc">Win up to ₹10,000 daily!</p><button class="banner-btn" onclick="window.app.openAuthModal('login')">Play Now →</button></div></div></div>
                        <div class="banner-slide"><div class="banner-card banner-4"><div class="banner-content"><h2 class="banner-title">🔒 100% Safe & Legal</h2><p class="banner-desc">Skill-based gaming platform</p><button class="banner-btn" onclick="window.app.openAuthModal('register')">Get Started →</button></div></div></div>
                    </div>
                ...
                <div class="section-container">
                    ...
                    <div class="tournament-grid-zupee">
                        <div class="tournament-card-zupee" onclick="window.app.handleJoinMatch(10)"><div class="tcz-header"><span class="tcz-badge badge-green">Entry ₹10</span></div><div class="tcz-body"><div class="tcz-prize-row"><span class="tcz-prize-amount">Win ₹17</span></div></div></div>
                        <div class="tournament-card-zupee featured-card" onclick="window.app.handleJoinMatch(20)"><div class="tcz-header"><span class="tcz-badge badge-orange">Entry ₹20</span></div><div class="tcz-body"><div class="tcz-prize-row"><span class="tcz-prize-amount">Win ₹34</span></div></div></div>
                        <div class="tournament-card-zupee" onclick="window.app.handleJoinMatch(50)"><div class="tcz-header"><span class="tcz-badge badge-purple">Entry ₹50</span></div><div class="tcz-body"><div class="tcz-prize-row"><span class="tcz-prize-amount">Win ₹85</span></div></div></div>
                        <div class="tournament-card-zupee premium-card" onclick="window.app.handleJoinMatch(100)"><div class="tcz-header"><span class="tcz-badge badge-gold">Entry ₹100</span></div><div class="tcz-body"><div class="tcz-prize-row"><span class="tcz-prize-amount">Win ₹170</span></div></div></div>
                    </div>
                </div>
            ...
            <section id="page-history" class="page">
                ...
                <div style="padding:16px;">
                    ...
                    <div id="historyList" style="margin-top:12px;"><p style="color:rgba(255,255,255,0.6);text-align:center;padding:20px;">Login to view history</p></div>
                </div>
            </section>
            ...
            <section id="page-refer" class="page">
                ...
                <div style="padding:16px;">
                    <div class="refer-hero-card" style="text-align:center;padding:24px;">
                        ...
                        <div class="refer-code-box" style="margin:16px 0;"><span id="referCodeText" style="font-size:22px;font-weight:800;color:#FFD700;letter-spacing:2px;">REF123456</span><button class="btn-copy" id="copyCodeBtn">📋 Copy</button></div>
                ...
                <div style="padding:16px;">
                    ...
                    <div id="kycSection" style="display:none;margin-top:12px;background:#a10303;padding:16px;border-radius:12px;">
                        ...
                        <div class="kyc-form">
                            ...
                            <select id="kycDocType"><option value="pan">PAN Card</option><option value="aadhaar">Aadhaar Card</option></select>
            ...
            <section id="page-support" class="page">
                ...
                <div style="padding:16px;">
                    ...
                    <div style="margin-top:16px;display:flex;flex-direction:column;gap:10px;">
                        <div style="background:#a10303;padding:14px;border-radius:10px;display:flex;align-items:center;gap:12px;"><span style="font-size:28px;">📧</span><div><strong style="color:white;">Email Us</strong><p style="color:rgba(255,255,255,0.7);font-size:12px;">support@ludopro.com</p></div></div>
                        <div style="background:#a10303;padding:14px;border-radius:10px;display:flex;align-items:center;gap:12px;"><span style="font-size:28px;">📱</span><div><strong style="color:white;">WhatsApp</strong><p style="color:rgba(255,255,255,0.7);font-size:12px;">+91 99999 99999</p></div></div>
                        <div style="background:#a10303;padding:14px;border-radius:10px;display:flex;align-items:center;gap:12px;"><span style="font-size:28px;">💬</span><div><strong style="color:white;">Live Chat</strong><p style="color:rgba(255,255,255,0.7);font-size:12px;">Available 10AM - 8PM</p></div></div>
                    </div>
                </div>
            </section>
    ...
    (function() {
        ...
        LudoApp.prototype.applyLanguage = function() {
            ...
            if (this.isLoggedIn) { var btn = document.getElementById('logoutBtnProfile'); if (btn) btn.textContent = '🚪 ' + (t.logout || 'Logout'); }
        };
        ...
        // ==============================================
        // FIXED: handleRegister - CSRF SYNC
        // ==============================================
        LudoApp.prototype.handleRegister = async function() {
            ...
            var data = { username: document.getElementById('regUsername').value.trim(), mobile: document.getElementById('regMobile').value.trim(), password: document.getElementById('regPassword').value };
        ...
        LudoApp.prototype.fetchWalletBalance = async function() {
            ...
            try {
                var res = await fetch(this.basePath + '/api/wallet.php?action=balance', { credentials: 'include', headers: { 'Accept': 'application/json' } });
                if (res.status === 401) { this.isLoggedIn = false; this.userData = null; this.updateUI(); return; }
                ...
                if (data.success) {
                    ...
                    var wl = document.getElementById('walletLarge'); if (wl) wl.textContent = '₹' + this.walletBalance.toFixed(2);
        ...
        LudoApp.prototype.fetchWalletTransactions = async function() {
            if (!this.isLoggedIn) return;
            try {
                var res = await fetch(this.basePath + '/api/wallet.php?action=history&limit=20', { credentials: 'include', headers: { 'Accept': 'application/json' } });
                ...
                if (data.success && data.data.transactions && data.data.transactions.length > 0) {
                    ...
                    data.data.transactions.forEach(function(tx) {
                        var color = tx.type === 'credit' ? '#FFD700' : '#EF4444'; var sign = tx.type === 'credit' ? '+' : '-';
                        ...
                        html += '<span style="color:' + color + ';font-weight:700;font-size:15px;">' + sign + '₹' + parseFloat(tx.amount).toFixed(2) + '</span></div>';
                    });
                    container.innerHTML = html;
                } else { container.innerHTML = '<p style="color:rgba(255,255,255,0.6);text-align:center;padding:20px;">No transactions yet</p>'; }
            } catch (e) { console.error('Wallet transactions error:', e); }
        };

        LudoApp.prototype.bindWalletEvents = function() {
            var self = this;
            document.getElementById('addMoneyBtn').addEventListener('click', function() { if (!self.isLoggedIn) { showToast('Please login first', 'error'); self.openAuthModal('login'); return; } showToast('💳 Payment gateway integration coming soon!', 'info'); });
            document.getElementById('withdrawBtn').addEventListener('click', function() { if (!self.isLoggedIn) { showToast('Please login first', 'error'); self.openAuthModal('login'); return; } showToast('🏦 Withdrawal feature coming soon!', 'info'); });
            document.getElementById('copyCodeBtn').addEventListener('click', function() { var code = document.getElementById('referCodeText').textContent || 'REF123456'; navigator.clipboard.writeText(code).then(function() { showToast('✅ Code copied!', 'success'); }); });
        };

        LudoApp.prototype.fetchCompleteHistory = async function() {
            if (!this.isLoggedIn) { document.getElementById('historyList').innerHTML = '<p style="color:rgba(255,255,255,0.6);text-align:center;padding:40px;">Please login to view history</p>'; return; }
            ...
            try {
                var txRes = await fetch(this.basePath + '/api/wallet.php?action=history&limit=50', { credentials: 'include', headers: { 'Accept': 'application/json' } });
                if (txRes.status === 401) { document.getElementById('historyList').innerHTML = '<p style="color:#EF4444;text-align:center;padding:40px;">Session expired. Please login again.</p>'; return; }
                var txData = await txRes.json();
                var matchRes = await fetch(this.basePath + '/api/match.php?action=get_history&limit=20', { credentials: 'include', headers: { 'Accept': 'application/json' } });
                var matchData = matchRes.ok ? await matchRes.json() : { success: false, data: { matches: [] } };
                var allItems = [];
                if (txData.success && txData.data.transactions) { txData.data.transactions.forEach(function(tx) { allItems.push({ type: tx.source || tx.type, title: tx.description || 'Transaction', amount: parseFloat(tx.amount), isCredit: tx.type === 'credit', date: tx.created_at, category: tx.source }); }); }
                if (matchData.success && matchData.data.matches) {
                    var uid = this.userData ? this.userData.id : null;
                    matchData.data.matches.forEach(function(m) { var isWin = (m.winner_id == uid); allItems.push({ type: 'match', title: (m.player1_name || '?') + ' vs ' + (m.player2_name || '?'), amount: isWin ? parseFloat(m.winning_amount || m.prize_pool || 0) : parseFloat(m.entry_fee || 0), isCredit: isWin, date: m.completed_at || m.created_at, category: isWin ? 'match_win' : 'match_fee' }); });
                }
                allItems.sort(function(a, b) { return new Date(b.date) - new Date(a.date); });
                this.allHistoryData = allItems;
                this.renderHistory(allItems);
            } catch (e) { console.error('History error:', e); document.getElementById('historyList').innerHTML = '<p style="color:#EF4444;text-align:center;padding:20px;">Error loading history</p>'; }
        };

        LudoApp.prototype.renderHistory = function(items) {
            var container = document.getElementById('historyList');
            if (!items || items.length === 0) { container.innerHTML = '<p style="color:rgba(255,255,255,0.6);text-align:center;padding:40px;">📭 No history yet</p>'; return; }
            ...
            items.forEach(function(item) {
                var icon = icons[item.category] || '💳'; var color = colors[item.category] || '#94a3b8'; var sign = item.isCredit ? '+' : '-';
                ...
                html += '<span style="color:' + (item.isCredit ? '#FFD700' : '#EF4444') + ';font-weight:700;font-size:15px;white-space:nowrap;">' + sign + '₹' + item.amount.toFixed(2) + '</span></div>';
            });
            container.innerHTML = html;
        };
        ...
        LudoApp.prototype.filterHistory = function(filter) {
            ...
            else { var filtered = this.allHistoryData.filter(function(item) { return item.category === filter; }); this.renderHistory(filtered); }
        };

        // ==============================================
        // FIXED: handleJoinMatch - CSRF AUTO-REFRESH
        // ==============================================
        LudoApp.prototype.handleJoinMatch = async function(entryFee) {
            ...
            var csrf = this.csrfToken || localStorage.getItem('csrf_token') || '';
            if (!csrf || csrf.length < 10) {
                try {
                    var csrfRes = await fetch(this.basePath + '/api/auth.php?action=get_csrf', { credentials: 'include' });
                    var csrfData = await csrfRes.json();
                    if (csrfData.success && csrfData.data.csrf_token) { csrf = csrfData.data.csrf_token; this.csrfToken = csrf; localStorage.setItem('csrf_token', csrf); }
                } catch (e) {}
            }
            if (!csrf || csrf.length < 10) { showToast('Session expired. Please login again.', 'error'); this.openAuthModal('login'); return; }
            
            showToast('Searching for opponent...', 'info');
            try {
                var makeRequest = async function(token) {
                    return await fetch(this.basePath + '/api/match.php?action=join', { method: 'POST', headers: { 'Content-Type': 'application/json', 'X-CSRF-Token': token }, credentials: 'include', body: JSON.stringify({ entry_fee: entryFee, tournament_id: 1, csrf_token: token }) });
                }.bind(this);
                
                var res = await makeRequest(csrf);
                if (res.status === 401) { showToast('Session expired. Please login again.', 'error'); this.openAuthModal('login'); return; }
                if (res.status === 403) {
                    var newCsrfRes = await fetch(this.basePath + '/api/auth.php?action=get_csrf', { credentials: 'include' });
                    var newCsrfData = await newCsrfRes.json();
                    if (newCsrfData.success && newCsrfData.data.csrf_token) { this.csrfToken = newCsrfData.data.csrf_token; localStorage.setItem('csrf_token', this.csrfToken); res = await makeRequest(this.csrfToken); }
                }
                var data = await res.json();
                if (data.success) {
                    this.fetchWalletBalance();
                    if (data.data.match_id) { showToast('✅ Match found! Redirecting...', 'success'); setTimeout(function() { window.location.href = this.basePath + '/game.php?match_id=' + data.data.match_id; }.bind(this), 1000); }
                    else { showToast('⏳ Waiting for opponent... Room: ' + (data.data.room_code || 'N/A'), 'info'); }
                } else { showToast('❌ ' + (data.message || 'Failed to join match'), 'error'); }
            } catch (e) { console.error('Join match error:', e); showToast('Network error. Please try again.', 'error'); }
        };

        LudoApp.prototype.loadTournaments = async function() {
            try {
                var res = await fetch(this.basePath + '/api/tournament_system.php?action=list_active', { credentials: 'include', headers: { 'Accept': 'application/json' } });
                var data = await res.json();
                ...
                if (data.success && data.data.tournaments && data.data.tournaments.length > 0) {
                    var html = '';
                    data.data.tournaments.forEach(function(t) { html += '<div class="tournament-card-zupee" onclick="window.app.handleJoinMatch(' + parseFloat(t.entry_fee) + ')"><div class="tcz-header"><span class="tcz-badge badge-green">' + t.game_mode + '</span></div><div class="tcz-body"><div class="tcz-prize-row"><span class="tcz-prize-amount">₹' + parseFloat(t.entry_fee).toFixed(0) + '</span></div></div></div>'; });
                    container.innerHTML = html;
                }
            } catch (e) {}
        };

        LudoApp.prototype.openPopup = function(index) { this.currentPopupIndex = index; var overlay = document.getElementById('popupOverlay'); var img = document.getElementById('popupImage'); var dots = document.querySelectorAll('.popup-dot'); if (POPUP_IMAGES[index]) img.src = POPUP_IMAGES[index]; dots.forEach(function(d, i) { d.classList.toggle('active', i === index); }); overlay.classList.add('active'); };
        LudoApp.prototype.closePopup = function() { document.getElementById('popupOverlay').classList.remove('active'); };

        LudoApp.prototype.updateUI = function() {
            var loggedIn = this.isLoggedIn;
            var loginBtn = document.getElementById('loginBtnProfile'); var regBtn = document.getElementById('registerBtnProfile');
            var logoutBtn = document.getElementById('logoutBtnProfile'); var headerLoginBtn = document.getElementById('headerLoginBtn');
            ...
            if (this.userData) { var profileName = document.getElementById('profileName'); var referCode = document.getElementById('referCodeText'); if (profileName) profileName.textContent = this.userData.username || 'Player'; if (referCode) referCode.textContent = this.userData.refer_code || 'REF123456'; }
        };

        LudoApp.prototype.showKYCSection = function() { var section = document.getElementById('kycSection'); if (section) section.style.display = (section.style.display === 'none' || section.style.display === '') ? 'block' : 'none'; };
        LudoApp.prototype.showBankSection = function() { var section = document.getElementById('bankSection'); if (section) section.style.display = (section.style.display === 'none' || section.style.display === '') ? 'block' : 'none'; };
        LudoApp.prototype.submitKYC = function() { var name = document.getElementById('kycFullName').value; var doc = document.getElementById('kycDocNumber').value; if (!name || !doc) { showToast('Please fill all KYC fields', 'error'); return; } showToast('✅ KYC submitted successfully! Pending verification.', 'success'); };
        LudoApp.prototype.saveBankDetails = function() { var name = document.getElementById('bankAccountName').value; var acct = document.getElementById('bankAccountNumber').value; if (!name || !acct) { showToast('Please fill bank account details', 'error'); return; } showToast('✅ Bank details saved successfully!', 'success'); };
        LudoApp.prototype.shareOn = function(platform) { var code = document.getElementById('referCodeText').textContent || 'REF123456'; var url = encodeURIComponent(window.location.href); var text = encodeURIComponent('🎲 Join Ludo Pro & earn real cash! Use my code: ' + code + '\n'); var links = { whatsapp: 'https://wa.me/?text=' + text + url, telegram: 'https://t.me/share/url?url=' + url + '&text=' + text, facebook: 'https://www.facebook.com/sharer/sharer.php?u=' + url, twitter: 'https://twitter.com/intent/tweet?text=' + text + '&url=' + url }; if (links[platform]) window.open(links[platform], '_blank'); };
        LudoApp.prototype.copyReferLink = function() { var code = document.getElementById('referCodeText').textContent || 'REF123456'; var text = '🎲 Join Ludo Pro! Use code: ' + code + '\n' + window.location.href; navigator.clipboard.writeText(text).then(function() { showToast('✅ Link copied!', 'success'); }); };
